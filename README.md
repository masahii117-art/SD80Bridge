...
SD80 Bridge Ver.1**初回リリース

SD80 Bridge Ver.1.0.1
- MidiSrv停止待ち時間を250msから100msに変更しました。
- MidiSrv強制終了後の追加待機（5秒）は無効のままとしています。
Ver.1をベースにしたマイナーアップデートです。上記以外の機能変更はありません。
